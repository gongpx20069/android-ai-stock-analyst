...
- **喂 AI agent**(见 github-benchmark §4):基本面 agent 吃"上行空间%/前瞻PE/评级",技术面 agent 吃"支撑压力位/RSI/均线"(说"现价离支撑2%、离压力9%,风险收益比不错")。
- **喂 ML 模型**(见 ml-prediction):把"距支撑%/距压力%/RSI/上行空间%"做成**特征**,让模型用你认可的逻辑学习。

---

## 6. 决策登记

I1–I4 已定(2026-06-30,你授权拍板),登记在 [`architecture.md` §3.1 台账](architecture.md#3-决策台账全项目唯一决策出处);执行细节即本文 §2(4算法/主轴/共振)、§3(技术面 MVP),不再重复罗列。
