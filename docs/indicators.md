...
## 6. ✅ 已定(2026-06-30,你授权我拍板)

- [x] I1. 支撑压力 **4 种算法全做**(纯 numpy,毫秒级,成本极低)。呈现分主次:**②波段高低 + ④均线/52周 为主轴**(最贴你的中线风格),①枢轴点(短线)、③斐波那契作为详情页"更多"展开。
- [x] I2. **做醒目数字卡**:"距最近支撑 −X% / 距最近压力 +Y%" 与上行空间%、前瞻PE 并列。
- [x] I3. **做多方法共振高亮**:≥2 种方法命中的价位加粗,标可靠度。
- [x] I4. 技术面 MVP = **MA50/200 + RSI(14) + 52周位置**(精简,防止技术指标喧宾夺主);MACD/布林/ATR 放二期。
